...
use yii\bootstrap\ActiveForm;
  ...
  use app\modules\warehouse\models\AuthUser;
...
<div class="module-login" style="
    ...
    <?= $form->field($model, 'password')->passwordInput()->label(Module::t('app', 'Password')); ?>

    <?= $form->field($model, 'rememberMe', [
        'template' => "<div class=\"col-lg-offset-1 col-lg-3\">{input}</div>\n<div class=\"col-lg-8\">{error}</div>",
    ])->checkbox()->label(Module::t('app', 'Remember me')); ?>

    <div class="form-group">
        <div class="col-lg-offset-1 <!--col-lg-11-->">
            <?= Html::submitButton(Module::t('app', 'Login'), ['class' => 'btn btn-primary', 'name' => 'login-button']) ?>
        </div>
    </div>
